    ...
    <div className="mt-10 p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-1 bg-gray-200 p-4">
          ...
          {/* Dropdown For Brands */}
          <div className="mb-4">
            <label className="block text-black font-medium">Select Dress:</label>
            <select
              className="w-full p-2 border rounded mt-2"
              value={selectedBrand}
              onChange={(e) => setSelectedBrand(e.target.value)}
            >
              <option value="All Dress">All Dress</option>
        ...
        <div className="md:col-span-2 lg:col-span-3 bg-gray-200 p-4">
          <p className="text-black text-2xl md:text-3xl font-bold">Dresses</p>
