        ...
        <div className="w-full sm:w-auto sm:flex-1 sm:flex sm:justify-center order-2 sm:order-none mt-4">
          <div className="flex relative items-center rounded-md px-3 py-1 h-12 w-full sm:w-80 md:w-96 lg:w-[28rem]">
            ...
            <input
              type="text"
              placeholder="Search"
              className="pl-12 pr-4 py-2 w-full focus:outline-none border-2 border-fuchsia-200 hover:border-fuchsia-300 focus:border-fuchsia-300 hover:bg-fuchsia-100 focus:bg-fuchsia-200 text-lg rounded-2xl transition duration-300"
            />
          </div>
        </div>
