  ...
  return (
    <div className="w-full">
      ...
      <div className="px-6 md:px-12 lg:px-20 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="w-full sm:w-auto sm:flex-1 sm:flex sm:justify-center order-2 sm:order-none">
          <div className="flex relative items-center rounded-md px-3 py-1 h-12  w-full sm:w-80 md:w-96 lg:w-[28rem]">
            <FaSearch className="text-gray-500 text-2xl absolute left-3 top-1/2 -translate-y-1/2" />
            <input
              type="text"
              placeholder="Search"
